...
//            viewHolder.ivUserProfile.setImageBitmap(profileImage);
        ...
        if (mentions.isRetweeted()) viewHolder.ivRetweet.setImageResource(R.mipmap.ic_retweeted);
        ...
        if (mentions.isFavorited()) viewHolder.ivFavorite.setImageResource(R.mipmap.ic_favorited);
    ...
    private View.OnClickListener retweetSelected = new View.OnClickListener() {
        ...
        public void onClick(final View v) {
            ...
            final Mentions t = Mentions.getById(id);
